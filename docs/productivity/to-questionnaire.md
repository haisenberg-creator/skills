...
- One idea per question, never compound, with an answer stub beneath it and a _why this matters_ line only where a question could be misread.
...
- The questions read as aimed at what the _recipient_ knows, not as your own open questions copied down verbatim.
